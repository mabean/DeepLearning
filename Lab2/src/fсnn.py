...
b1 = tf.get_variable('b1', [hidden_layer1_size], initializer=tf.constant_initializer(0.0))
y1 = tf.nn.relu(tf.matmul(x, W1) + b1)

W2 = tf.get_variable('W2', [hidden_layer1_size, hidden_layer2_size], initializer=tf.random_normal_initializer())
b2 = tf.get_variable('b2', [hidden_layer2_size], initializer=tf.constant_initializer(0.0))
y2 = tf.nn.relu(tf.matmul(y1, W2) + b2)

W3 = tf.get_variable('W3', [hidden_layer2_size, classes_size], initializer=tf.random_normal_initializer())
b3 = tf.get_variable('b3', [classes_size], initializer=tf.constant_initializer(0.0))
